...
{
  [Guid("e30efad6-d747-4181-8a65-397b3f2bc359")]
  public class PluginServer : ApplicationAddInServer
  {
    ...
    {
      Trace.TraceInformation(": ExtractParamsPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
    ...
    {
      Trace.TraceInformation(": ExtractParamsPlugin: deactivating... ");
